...
{
	private final SliderSetting fallSpeed = new SliderSetting("下落速度", 0.125,
		0.005, 0.25, 0.005, ValueDisplay.DECIMAL);
	
	private final SliderSetting moveSpeed = new SliderSetting("移动速度", "水平移动系数。",
		1.2, 1, 5, 0.05, ValueDisplay.PERCENTAGE);
	
	private final SliderSetting minHeight =
		new SliderSetting("最小高度", "当你离地面太近时不会滑翔。", 0, 0, 2, 0.01,
